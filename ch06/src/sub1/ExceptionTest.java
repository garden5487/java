...
public class ExceptionTest {
       public static void main(String[] args) {
    	   ...
    	   try {
    		   // Try : 예외가 발생 가능한 코드 작성에 작성
    	      r4 = num1 / num2;   // 예외발생, 프로그램 중단
    	   } catch (Exception e) { // 다형성이 적용된 catch 구문
    		   // catch : 예외가 발생 했을때 처리 작성
    	   ...
    	   // 동적 객체 생성
    	   try {
			Class clazz = Class.forName("sub1.Eagle"); // sub 패키지에 Eagle 클래스 정보 불러오기
