...
public class StringTest {
	public static void main(String[] args) {
		...
		System.out.println("messge 길이 : " + message.length());
		...
		System.out.println("messge 문자열 0 ~ 5까지 문자열 : " + sub1);
		System.out.println("messge 문자열 6 ~ 마지막까지 문자열 : " + sub2);
